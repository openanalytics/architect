...
public class IDEApplicationCompatibility {
    ...
    public Shell getShell(Display display) throws Exception {
	...
	public Object checkInstanceLocation(Shell shell, Map applicationArguments) {
